  ...
  <body class="landing-wrraper">
    ...
    <div class="page-wrapper" id="pageWrapper">
      ...
      <div class="container-fluid p-0 m-0">
        <div class="comingsoon comingsoon-bgimg" style="background-image: url('{{asset('storage/'.$event->poster_image)}}');background-attachment: fixed;background-position: center;background-repeat: no-repeat;background-size: cover;">
      ...
      <div class="container">
        <section id="about">
            <h3 class="text-center">About this event</h3>
            <hr>
            <div class="card card-absolute my-3 shadow">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="{{asset('storage/'.$event->poster_image)}}" alt="" class="img-fluid">
                        </div>
                        <div class="col sm-6">
                            <p>{!! $event->description !!}.</p>
                            <div class="row">
                                <div class="col-sm-6">
                                    <span class="badge badge-success badge-pill"><strong>Start Date:</strong> {{ $event->start_date }}  @ {{ $event->start_time }}</span>
                                </div>
                                <div class="col-sm-6">
                                    <span class="badge badge-warning badge-pill"><strong>End Date:</strong> {{ $event->end_date }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog flipInX  animated" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Buy Ticket for - {{ $event->name }}</h5>
              <button type="button" class="btn btn-light" data-bs-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('payments.stkpush',$event->id,'pay') }}" method="POST">
                    @csrf
