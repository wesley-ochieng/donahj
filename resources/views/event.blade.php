...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Jane Aller">
    <meta name="keywords" content="Jane Aller Get Tickets">
    ...
    <title>Jane Aller Tickets</title>
    <!-- Google font-->
                ...
                <div class="col-12">
                    <nav class="navbar navbar-light p-0" id="navbar-example2"><a class="navbar-brand"
                        href="javascript:void(0)"> <img class="img-fluid img-40"
                            src="{{ asset('assets/images/janealler.png') }}" alt=""></a>
        ...
        <div class="custom-container">
          <div class="row">
            <div class="col-md-6 col-sm-2">
              <div class="footer-contain"><img class="img-fluid img-40" src="{{ asset('assets/images/janealler.png') }}"  alt=""></div>
            </div>
            <div class="col-md-6 col-sm-10">
              <div class="footer-contain">
                <p class="mb-0">Copyright 2022-23 © Jane Aller All rights reserved. </p>
              </div>
            </div>
          </div>
        </div>
